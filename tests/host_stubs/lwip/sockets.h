...
static inline in_port_t htons(in_port_t v) { return v; }
static inline in_port_t ntohs(in_port_t v) { return v; }
static inline in_addr_t htonl(in_addr_t v) { return v; }
static inline in_addr_t ntohl(in_addr_t v) { return v; }
#else
static inline in_port_t htons(in_port_t v)
{
    return (in_port_t)(((v & 0xFFu) << 8) | ((v >> 8) & 0xFFu));
}
static inline in_port_t ntohs(in_port_t v) { return htons(v); }
static inline in_addr_t htonl(in_addr_t v)
{
    return (in_addr_t)(((v & 0xFFu) << 24) | ((v & 0xFF00u) << 8) |
                       ((v >> 8) & 0xFF00u) | ((v >> 24) & 0xFFu));
}
static inline in_addr_t ntohl(in_addr_t v) { return htonl(v); }
#endif
